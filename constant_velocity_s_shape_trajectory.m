function [x_star, y_star, x_star_dot, y_star_dot, theta_star, theta_star_dot, t, duration] = ...
    ...
    x_star_2 = x_center - 2*trajectory_radius + trajectory_radius * cos(theta_star_1);
    y_star_2 = y_center - trajectory_radius * sin(theta_star_1);
    x_star_dot_2 = -v_constant * sin(theta_star_1);  % Derivative remains the same
    y_star_dot_2 = -v_constant * cos(theta_star_1);  % Derivative remains the same
