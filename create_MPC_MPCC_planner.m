function [solver, args] = create_MPC_MPCC_planner( ...
    ...
    for i = 1:N
        ...
        for j = 1:n_obstacles
            ...
            g = [g; obs_dist - obstacles(3,j) - len/2 - radius - 0.005];
            args.lbg(constraint_offset,1) = 0;
            args.ubg(constraint_offset,1) = inf;
            constraint_offset = constraint_offset + 1;
        end
    ...
    opts.knitro.xtol = 1e-10;
    opts.knitro.feastol = 1e-5;
    opts.knitro.feastol_abs = 1e-3;
    opts.knitro.opttol = 1e-5;
    opts.knitro.opttol_abs = 1e-3;
    opts.knitro.bar_maxcrossit = 10;
    opts.knitro.strat_warm_start = 1;
    opts.knitro.numthreads = 8;
    opts.knitro.restarts = 10;
    opts.knitro.restarts_maxit = 800;
    opts.knitro.scale = 3;
    opts.knitro.maxtime = 100;
